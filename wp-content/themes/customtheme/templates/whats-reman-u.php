...
<div class="container-fluid">
    <h3 class="mt-5">What's REMAN U?</h3>
    <div class="d-flex" style="height: 80vh">
        <iframe id="videoFrame" src="https://www.youtube.com/embed/tgbNymZ7vqY?wmode=transparent" wmode="Opaque" class="w-100" frameborder="0"></iframe>
    </div>
