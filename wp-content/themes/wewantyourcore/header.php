...
<head>
	...
	<link rel="shortcut icon" href="<?php echo get_template_directory_uri() ?>/img/wewantyourcore-logo.png" type="image/x-icon">
	...
	<nav>
	    <div class="nav-wrapper white-bg nav-on-mobile-bg">
	      <a href="<?php echo home_url() ?>" class="brand-logo">
			  <img src="<?php echo get_template_directory_uri() ?>/img/wewantyourcore-logo.png" alt="Etereman" class="etereman-logo">
		  </a>
